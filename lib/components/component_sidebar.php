    ...
    <div class="vertical-menu">
        ...
        <div class="navbar-brand-box">
            <a href="index.html" class="logo logo-dark">
                <span class="logo-sm">
                    <img src="[MART_LOGO]" alt="" height="40">
                </span>
                <span class="logo-lg">
                    <img src="[MART_LOGO]" alt="" height="40">
                </span>Mart
            ...
            <a href="index.html" class="logo logo-light logo-tetx">
                <span class="logo-lg">
                    <img src="[MART_LOGO]" alt="" height="40"> MART 2 MART
                </span>
                <span class="logo-sm">
                    <img src="[MART_LOGO]" alt="" height="40"> 
                </span>
                ...
                <ul class="metismenu list-unstyled" id="side-menu">
                    ...
                    <li>
                        <a href="javascript: void(0);" class="has-arrow">
                            ...
                            <span class="menu-item" data-key="t-ecommerce">Products Details</span>
                        </a>
                        <ul class="sub-menu" aria-expanded="false">
                            <li><a href="ecommerce-products.html" data-key="t-products">Products</a></li>
                            <li><a href="ecommerce-product-detail.html" data-key="t-product-detail">Product Price</a></li>
                    ...
                    <li>
                        <a href="javascript: void(0);" class="has-arrow">
                            <i class="icon nav-icon" data-eva="shopping-bag-outline"></i>
                            <span class="menu-item" data-key="t-ecommerce">Service Details</span>
                        </a>
                        <ul class="sub-menu" aria-expanded="false">
                            <li><a href="ecommerce-products.html" data-key="t-products">Service</a></li>
                            <li><a href="ecommerce-product-detail.html" data-key="t-product-detail">Service Category</a></li>
                            <li><a href="ecommerce-add-product.html" data-key="t-add-product">Add Service</a></li>
                        </ul>
                    </li>
                    <li>
                        <a href="javascript: void(0);" class="has-arrow">
                            <i class="icon nav-icon" data-eva="shopping-bag-outline"></i>
                            <span class="menu-item" data-key="t-ecommerce">Enquiry Details</span>
                        </a>
                        <ul class="sub-menu" aria-expanded="false">
                            <li><a href="ecommerce-products.html" data-key="t-products">Enquiry</a></li>
                            <li><a href="ecommerce-product-detail.html" data-key="t-product-detail">Enquiry Replay </a></li>
                            <li><a href="ecommerce-add-product.html" data-key="t-add-product">Add Enquiry</a></li>
                        </ul>
                    </li>
                    <li>
                    <a href="javascript: void(0);" class="has-arrow">
                        <i class="icon nav-icon" data-eva="shopping-bag-outline"></i>
                        <span class="menu-item" data-key="t-ecommerce">Users Details</span>
                    </a>
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="ecommerce-products.html" data-key="t-products">Users</a></li>
                        <li><a href="ecommerce-product-detail.html" data-key="t-product-detail">Users Active </a></li>
                        <li><a href="ecommerce-product-detail.html" data-key="t-product-detail">Users Deactive </a></li>
                        <li><a href="#" data-key="t-add-product">Add Users</a></li>
                    </ul>
                </li>
                <li>
                    <a href="javascript: void(0);" class="has-arrow">
                        <i class="icon nav-icon" data-eva="shopping-bag-outline"></i>
                        <span class="menu-item" data-key="t-ecommerce">Country Details</span>
                    </a>
                    <ul class="sub-menu" aria-expanded="false">
